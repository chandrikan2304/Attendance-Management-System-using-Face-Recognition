    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Chandrika/Downloads/P2-Attendance-Management-System-using-Face-Recognition-main/Attendance/Computer Engineering_2024-11-26_14-03-10.csv'+DB_table_name+'.csv'
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv("C:/Users/Chandrika/Downloads/P2-Attendance-Management-System-using-Face-Recognition-main/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Chandrika/Downloads/P2-Attendance-Management-System-using-Face-Recognition-main/StudentDetails/StudentDetails.csv' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/Chandrika/Downloads/P2-Attendance-Management-System-using-Face-Recognition-main/StudentDetails/StudentDetails.csv"')
    ...
    def log_in():
        ...
        if username == 'Chandrika':
            if password == '123':
                ...
                cs = 'C:/Users/Chandrika/Downloads/P2-Attendance-Management-System-using-Face-Recognition-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
